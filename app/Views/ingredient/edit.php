        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input for="name" required id="name" type="text" class="form-control <?= isset($ing) ? "-plaintext" : ''; ?>" name="name" value="<?= isset($ing) ? $ing['name'] : ''; ?>">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="stock" class="col-sm-2 col-form-label">Stock</label>
                    <div class="col-sm-10">
                        <input for="stock" required id="stock" type="text" class="form-control" name="stock" value="<?= isset($ing) ? $ing['stock'] : ''; ?>" required>
                    </div>
                </div>
                <div class="mb-3 row">
